...
namespace ContextMenuManager.Controls
{
    sealed class ShellExItem : FoldSubItem, IChkVisibleItem, IBtnShowMenuItem, ITsiGuidItem,
        ITsiFilePathItem, ITsiRegPathItem, ITsiRegDeleteItem, ITsiRegExportItem, IProtectOpenItem
    {
        ...
        private void InitializeComponents()
        {
            ...
            TsiDetails.DropDownItems.AddRange(new ToolStripItem[] {new ToolStripSeparator(),
