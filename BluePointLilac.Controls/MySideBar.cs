...
namespace BluePointLilac.Controls
{
    public sealed class MySideBar : Panel
    {
		public MySideBar()
		{
			...
			// --- NEW: Apply Theme and Accent Color ---
			bool isDark = ThemeManager.IsDarkMode();
			Color accentColor = ThemeManager.GetSystemAccentColor();

			// Generate a lighter color for the hover effect based on the accent color
			Color hoverColor = ControlPaint.Light(accentColor, 0.3f);
			...
			PnlSelected.BackColor = accentColor;
			PnlHovered.BackColor = hoverColor;
